...
import com.anderstak.knoweverything.topic.entities.Definition;
import com.anderstak.knoweverything.topic.entities.PartOfSpeech;
import com.anderstak.knoweverything.topic.entities.WordDefinition;
...
public class DefinitionScene extends HBox {
    ...
    public void setDefinition(Definition s) {
        ...
        int i = 1;
        for (WordDefinition w : s.getDefinitions()) {
            String text = i++ + ". ";
